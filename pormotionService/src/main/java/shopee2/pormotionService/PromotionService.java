...
public class PromotionService {
	...
	public List<Promotion> docToList(List<Promotion> promotionList, ApiFuture<QuerySnapshot> querySnapshot)
	...
	public Map<String, Object> getPromotion(int id) throws InterruptedException, ExecutionException {
		List<Promotion> promotionList = new ArrayList<Promotion>();
		CollectionReference Promotion = db.getFireBase().collection("promotion");
	...
	public Map<String, Object> getPromotionCodeMatch(String code)
		...
		else if (!((Promotion) promotionList.get(0)).getStartDate().after(curentDAte)
				&& !((Promotion) promotionList.get(0)).getDueDate().before(curentDAte)) {
			try {
				Map<String, Object> status = new HashMap<String, Object>();
				status.put("status", "success");
	...
	public Map<String, Object> updatePromotion(Promotion promotion, int id)
			throws InterruptedException, ExecutionException, JsonProcessingException {
		List<Promotion> promotionList = new ArrayList<Promotion>();
		CollectionReference PromotionGet = db.getFireBase().collection("promotion");
		...
		p.setDiscountInPrice(
				promotion.getDiscountInPrice() != null ? promotion.getDiscountInPrice() : p.getDiscountInPrice());
		p.setDiscountInPercent(
				promotion.getDiscountInPercent() != null ? promotion.getDiscountInPercent() : p.getDiscountInPercent());
		p.setIsFreeDelivery(
				promotion.getIsFreeDelivery() != null ? promotion.getIsFreeDelivery() : p.getIsFreeDelivery());
		/*
		 * PromotionGet.document(String.valueOf(id)).set(p); return "success\n";
		 */
	...
	public Map<String, Object> deletePromotion(String id)
			throws InterruptedException, ExecutionException, JsonProcessingException {
